...
//  vc_handle htif_out_bits,
   ...
   vc_handle htif_reset,
   
   vc_handle htif_pcr_req_valid,
   vc_handle htif_pcr_req_bits_rw,
   vc_handle htif_pcr_req_bits_addr,
   vc_handle htif_pcr_req_bits_data,
                   
   vc_handle htif_pcr_rep_valid,
   vc_handle htif_pcr_rep_bits_data,
                   
   vc_handle htif_mem_req_valid,
   vc_handle htif_mem_req_bits_rw,
   vc_handle htif_mem_req_bits_addr,
   vc_handle htif_mem_req_bits_data,

   vc_handle htif_mem_rep_valid,
   vc_handle htif_mem_rep_bits,

   vc_handle exit
)
{
   // outputs of the htif module (going into the tile)
   vc_putScalar(htif_reset, htif->reset);

   htif->tick
   (
      // only inputs to the htif module go in here
   );
