  ...
  val io = new CpathIo()
   ...
   val csignals = 
      ListLookup(io.dat.dec_inst,                                   
                             List(N, BR_N  , OP1_X  , OP2_X    , OEN_0, OEN_0, ALU_X   , WB_X  , WA_X , REN_0, MEN_0, M_X  , CSR.N),
               Array(       /* val  |  BR  |  op1   |   op2     |  R1  |  R2  |  ALU    |  wb   | wa   | rf   | mem  | mem  | csr  */
                            /* inst | type |   sel  |    sel    |  oen |  oen |   fcn   |  sel  | sel  | wen  |  en  |  wr  | cmd  */
                  LW     -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_ADD , WB_MEM, WA_RD, REN_1, MEN_1, M_XRD, CSR.N),
                  SW     -> List(Y, BR_N  , OP1_RS1 , OP2_STYPE , OEN_1, OEN_1, ALU_ADD , WB_X  , WA_X , REN_0, MEN_1, M_XWR, CSR.N),
                  
                  AUIPC  -> List(Y, BR_N  , OP1_PCU , OP2_UTYPE , OEN_0, OEN_0, ALU_ADD   ,WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  LUI    -> List(Y, BR_N  , OP1_X   , OP2_UTYPE , OEN_0, OEN_0, ALU_COPY_2,WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                 
                  ADDI   -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_ADD , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  ANDI   -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_AND , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  ORI    -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_OR  , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  XORI   -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_XOR , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SLTI   -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_SLT , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SLTIU  -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_SLTU, WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SLLI   -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_SLL , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SRAI   -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_SRA , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SRLI   -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_0, ALU_SRL , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  
                  SLL    -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_SLL , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  ADD    -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_ADD , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SUB    -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_SUB , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SLT    -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_SLT , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  SLTU   -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_SLTU, WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  AND    -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_AND , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  OR     -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_OR  , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  XOR    -> List(Y, BR_N  , OP1_RS1 , OP2_RS2   , OEN_1, OEN_1, ALU_XOR , WB_ALU, WA_RD, REN_1, MEN_0, M_X  , CSR.N),
                  ...
                  BGE    -> List(Y, BR_GE , OP1_RS1 , OP2_SBTYPE, OEN_1, OEN_1, ALU_X   , WB_X  , WA_X , REN_0, MEN_0, M_X  , CSR.N),
                  BGEU   -> List(Y, BR_GEU, OP1_RS1 , OP2_SBTYPE, OEN_1, OEN_1, ALU_X   , WB_X  , WA_X , REN_0, MEN_0, M_X  , CSR.N),
                  BLT    -> List(Y, BR_LT , OP1_RS1 , OP2_SBTYPE, OEN_1, OEN_1, ALU_X   , WB_X  , WA_X , REN_0, MEN_0, M_X  , CSR.N),
                  BLTU   -> List(Y, BR_LTU, OP1_RS1 , OP2_SBTYPE, OEN_1, OEN_1, ALU_X   , WB_X  , WA_X , REN_0, MEN_0, M_X  , CSR.N),

                  CSRRWI -> List(Y, BR_N  , OP1_ZIMM, OP2_ITYPE , OEN_1, OEN_1, ALU_COPY_2,WB_CSR, WA_RD, REN_1, MEN_0, M_X  , CSR.W),
                  CSRRSI -> List(Y, BR_N  , OP1_ZIMM, OP2_ITYPE , OEN_1, OEN_1, ALU_COPY_2,WB_CSR, WA_RD, REN_1, MEN_0, M_X  , CSR.S),
                  CSRRW  -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_1, ALU_COPY_2,WB_CSR, WA_RD, REN_1, MEN_0, M_X  , CSR.W),
                  CSRRS  -> List(Y, BR_N  , OP1_RS1 , OP2_ITYPE , OEN_1, OEN_1, ALU_COPY_2,WB_CSR, WA_RD, REN_1, MEN_0, M_X  , CSR.S)
                  ))

   // Put these control signals in variables
   val cs_val_inst :: cs_br_type :: cs_op1_sel :: cs_op2_sel :: cs_rs1_oen :: cs_rs2_oen :: cs_alu_fun :: cs_wb_sel :: cs_wa_sel :: cs_rf_wen :: cs_mem_en :: cs_mem_fcn :: cs_csr_cmd :: Nil = csignals
